...
<head>
    ...
    <title>{{ config('app.name', 'MyApi') }}</title>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    @else
                        <ul class="navbar-nav me-auto">
                            <li class="nav-item">
                                <a class="nav-link text-dark" href="{{ route('info.all') }}">{{ __('All Users') }}</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link text-dark" href="{{ route('info.new') }}">{{ __('Add User') }}</a>
                            </li>
                        </ul>
                    @endguest
